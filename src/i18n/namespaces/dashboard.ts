...
export const dashboard = {
  en: {
    ...
    quantityUnitShares: 'shares',
    quantityTwHint: 'Taiwan holdings are counted in shares (股), not lots (張).',
    avgCost: 'Avg cost',
  ...
  'zh-TW': {
    ...
    weight: '占比',
    quantity: '持有股數',
    quantityUnitShares: '股',
    quantityTwHint: '台股以「股」記錄持有數量，不是「張」（1 張 = 1,000 股）。',
    avgCost: '平均成本',
    costBasis: '成本基礎',
    latestPrice: '最新價格',
